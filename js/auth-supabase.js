    ...
    try {
        ...
        if (user) {
            ...
            if (hasActiveSubscription) {
                // Se tem assinatura ativa, sempre redireciona para index.html, a menos que já esteja lá
                if (!currentPath.includes("/index.html")) {
                    window.location.href = "./index.html";
                }
            } else {
                // Se não tem assinatura ativa, sempre redireciona para planos.html, a menos que já esteja lá ou em login/register
                if (!currentPath.includes("/planos.html") && !currentPath.includes("/login.html") && !currentPath.includes("/register.html")) {
