...
async function checkAuthStatus() {
    ...
    try {
        ...
        if (session?.user) {
            ...
            // Se não há sessão, e não estamos na página de login/registro, redireciona para login.html
            if (!window.location.pathname.includes("login.html") && !window.location.pathname.includes("register.html")) {
        ...
        // Em caso de erro, se não estamos na página de login/registro, redireciona para login.html
        if (!window.location.pathname.includes("login.html") && !window.location.pathname.includes("register.html")) {
            window.location.href = getURL() + "login.html";
        }
    } finally {
...
function updateUserInterface(user) {
    ...
    if (logoutBtn) {
        logoutBtn.style.display = "block"; // Ou 'flex', dependendo do seu CSS
    }
}
